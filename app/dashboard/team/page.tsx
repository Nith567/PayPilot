...
const ROLE_DESCRIPTIONS: Record<MemberRole, string> = {
  ...
  treasurer: "Creates and approves payouts; a quorum signer",
  finance_officer: "Creates payout requests; joins the quorum as a signer",
...
export default function TeamPage() {
  ...
  const [role, setRole] = useState<MemberRole>("treasurer");
          ...
          return (
            <div key={m._id} className="flex flex-wrap items-center justify-between gap-3 px-5 py-3.5">
              ...
              <div className="flex items-center gap-2">
                ...
                {m.status === "active" &&
                (m.role === "treasurer" || m.role === "finance_officer") &&
                !m.inQuorum &&
                myRole === "owner" ? (
                  <Button
                    variant="ghost"
        ...
        <Card className="self-start">
          ...
          >
            ...
            <Field label="Role">
              ...
              >
                <option value="treasurer">Treasurer — create + approve payouts (signer)</option>
                <option value="finance_officer">Finance Officer — create requests (signer)</option>
            ...
            <p className="text-xs text-muted">
              ...
              on first login) → teammate accepts → they join the quorums as a
              signer automatically. Viewers stay read-only.
            </p>
          </form>
        </Card>
      ) : null}
